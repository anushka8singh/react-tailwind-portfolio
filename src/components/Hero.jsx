function Hero(){
    return(
        <section className="py-16 px-6">
            <div className="max-auto max-w-4xl space-y-4">
                <h1 className="text-4xl text-bold">Anushka Singh</h1>
                <h2 className="text-xl text-grey-600 mt-2">Aspiring Software Developer</h2>
